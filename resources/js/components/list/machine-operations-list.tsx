                            ...
                            return (
                                <tr key={idKey} className={`border-t relative ${rowBg}`}>
                                    <td className="px-2 py-1">
                                        <span title={duration ? `Czas trwania: ${duration} min` : undefined} className="cursor-help">
                                            {operationName}
                                        </span>
                                    </td>
                                    <td className="px-2 py-1">
                                    ...
                                    <td className="px-2 py-1 relative overflow-visible">
                                        ...
                                        {currentUserRole === 'moderator' || currentUserRole === 'admin' ? (
                                            <>
                                                <button
                                                    onClick={() => (onEdit ? onEdit(op) : console.log('edit', op))}
                                                ...
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="text-sm">
                                                            ...
                                                            <div className="text-xs text-gray-500">Czas: {duration ? `${duration} min` : '—'}</div>
                            ...
                            <div>
                                ...
                                <div className="text-sm">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <div className="text-xs mt-2">Czas: {selectedOp.duration_minutes ? `${selectedOp.duration_minutes} min` : '—'}</div>
